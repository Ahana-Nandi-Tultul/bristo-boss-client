...
const AdminHome = () => {
    ...
    const {data : stats = {}} = useQuery({
        ...
        enabled: !loading,
        queryFn: async() => {
            const res =  await instance('/admin-stats')
    ...
    const {data: chartData = []} = useQuery({
        ...
        queryFn: async() => {
            const res = await instance('/order-stats')
            return res.data;
        }
    })
    ...
    return (
        <div className="w-full p-4">
            <h2>Welcome to admin home, {user?.displayName}</h2>
            <div className="stats shadow w-full">
                ...
                <div className="stat">
                    ...
                    <div className="stat-title">Revenuew</div>
